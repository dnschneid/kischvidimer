...
from . import kicad_sch, kicad_pro
from . import git
...
class Page(object):
  ...
  def diff(self):
    ...
    if len(self.schs) == 2:
      ...
      conflicts = threeway(self.schs[0], self.schs[1], self.schs[2],
                           return_safe=diffs)
...
class Schematic(object):
  ...
  def _genui(self, v=0):
    ...
    if p: p.set_text("Processing hierarchy").set_incr_max_mult().incr_max(2).write()
